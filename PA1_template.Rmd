...
```{r totalaggregate, fig.height=4, fig.width=4}
...
```{r dailyaggregate, fig.width=8, fig.height=4}
...
```{r imputedaggregate, fig.height=4, fig.width=4}
...
```{r aggregateweekdays, fig.width=8, fig.height=4}
